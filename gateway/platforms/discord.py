...
class DiscordAdapter(BasePlatformAdapter):
    ...
    async def _handle_message(self, message: DiscordMessage) -> None:
        ...
        #   DISCORD_REQUIRE_MENTION: Set to "true" to require @mentions outside
        #       the free-response list. Default: "false".
        ...
        if not isinstance(message.channel, discord.DMChannel):
            ...
            require_mention = os.getenv("DISCORD_REQUIRE_MENTION", "false").lower() in ("true", "1", "yes")
